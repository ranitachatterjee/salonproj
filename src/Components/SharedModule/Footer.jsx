...
export default function Footer() {
  return (
    <div>
         {/* <!-- Footer Start --> */}
    <div class="footer container-fluid position-relative bg-dark py-5" style={{marginTop: '90px'}}>
    ...
    <div class="container-fluid bg-dark text-light border-top py-4" style={{borderColor: 'rgba(256, 256, 256, .15) !important'}}>
        <div class="container">
            <div class="row">
